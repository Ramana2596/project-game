...
export default function OperationalPlanInputTable({ tableData, isEnableTableActions, onSubmitApiCall }) {
    ...
    const tableHeading = ['Description', 'UOM', 'Quantity', 'Operation Info', 'Unit Price', 'currency', 'Info Price'];
    const tableHeadingForAdd = ['Description', 'Quantity', 'Unit Price', 'Info Price'];
    const hiddenTableColumns = ['Part', 'Qty_Id', 'Period', 'Price_Id'];
    ...
    const inputTypes = [
        ...
        { columnName: 'Operation_Info', inputType: 'select' },
