...
import { ResponsiveContainer, LineChart, Line, XAxis, YAxis, Tooltip, CartesianGrid, Legend, Label } from "recharts";

function ProfitPercentLineChart({ data }) {
            ...
            {hasData ? (
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={chartData} margin={{ top: 20, right: 30, left: 0, bottom: 5 }}>
                        ...
                        <Line type="monotone" dataKey="value" name="PAT%" stroke="#ff9800" strokeWidth={3} dot />
                    </LineChart>
                </ResponsiveContainer>
            ) : (
...
export default ProfitPercentLineChart;
