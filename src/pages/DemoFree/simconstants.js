// src/pages/SimulationSuiteNew/simconstants.js
...
// ✅ Stage definitions (same as DemoWizard.jsx, modularized here).
...
// ✅ Map stage numbers to display titles (labels only, no stage number).
